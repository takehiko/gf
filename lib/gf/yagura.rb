module GFLoad
  class Formation
    ...
    def build_yagura21
      ...
      p114 = GFLoad::Person.new(:name => "1.1.4"); add_person(p114)
      p121 = GFLoad::Person.new(:name => "1.2.1"); add_person(p121)
      p122 = GFLoad::Person.new(:name => "1.2.2"); add_person(p122)
      p123 = GFLoad::Person.new(:name => "1.2.3"); add_person(p123)
      p124 = GFLoad::Person.new(:name => "1.2.4"); add_person(p124)
      p211 = GFLoad::Person.new(:name => "2.1.1"); add_person(p211)
      p211.put_load(p111, 0.15)
      p211.put_load(p112, 0.15)
      p212 = GFLoad::Person.new(:name => "2.1.2"); add_person(p212)
      p212.put_load(p112, 0.15)
      p212.put_load(p113, 0.15)
      p213 = GFLoad::Person.new(:name => "2.1.3"); add_person(p213)
      p213.put_load(p113, 0.15)
      p213.put_load(p114, 0.15)
      p221 = GFLoad::Person.new(:name => "2.2.1"); add_person(p221)
      p221.put_load(p121, 0.15)
      p221.put_load(p122, 0.15)
      p222 = GFLoad::Person.new(:name => "2.2.2"); add_person(p222)
      p222.put_load(p122, 0.15)
      p222.put_load(p123, 0.15)
      p223 = GFLoad::Person.new(:name => "2.2.3"); add_person(p223)
      p223.put_load(p123, 0.15)
      p223.put_load(p124, 0.15)
      p311 = GFLoad::Person.new(:name => "3.1.1"); add_person(p311)
      p311.put_load(p211, 0.15)
      p311.put_load(p212, 0.15)
      p311.put_load(p111, 0.3)
      p311.put_load(p112, 0.4)
      p312 = GFLoad::Person.new(:name => "3.1.2"); add_person(p312)
      p312.put_load(p212, 0.15)
      p312.put_load(p213, 0.15)
      p312.put_load(p113, 0.4)
      p312.put_load(p114, 0.3)
      p321 = GFLoad::Person.new(:name => "3.2.1"); add_person(p321)
      p321.put_load(p221, 0.15)
      p321.put_load(p222, 0.15)
      p321.put_load(p121, 0.3)
      p321.put_load(p122, 0.4)
      p322 = GFLoad::Person.new(:name => "3.2.2"); add_person(p322)
