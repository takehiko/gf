module GF
  class Formation
    ...
    def build_yagura7
      # やぐら(7人技，3段タワー)を構成
      @level = 3
      p111 = GF::Person.new(:name => compose_name(lv(1), 1, 1)); add_person(p111)
      p112 = GF::Person.new(:name => compose_name(lv(1), 1, 2)); add_person(p112)
      p121 = GF::Person.new(:name => compose_name(lv(1), 2, 1)); add_person(p121)
      p122 = GF::Person.new(:name => compose_name(lv(1), 2, 2)); add_person(p122)
      p21 = GF::Person.new(:name => compose_name(lv(2), 1, 1)); add_person(p21)
      p21.put_load(p111, @default_hand_rate)
      p21.put_load(p112, @default_hand_rate)
      p22 = GF::Person.new(:name => compose_name(lv(2), 2, 1)); add_person(p22)
      p22.put_load(p121, @default_hand_rate)
      p22.put_load(p122, @default_hand_rate)
      p31 = GF::Person.new(:name => compose_name(lv(3), 1, 1)); add_person(p31)
      p31.put_load(p21, 0.5)
      p31.put_load(p22, 0.5)
    end
    ...
    def build_yagura9
      ...
      p32 = GF::Person.new(:name => compose_name(lv(3), 2, 1)); add_person(p32)
      p32.put_load(p22, @default_hand_rate * 2)
      p32.put_load(p121, @default_foot_rate)
      p32.put_load(p122, @default_foot_rate)
      p41 = GF::Person.new(:name => compose_name(lv(4), 1, 1)); add_person(p41)
    ...
    def build_yagura21
      ...
      p111 = GF::Person.new(:name => compose_name(lv(1), 1, 1)); add_person(p111)
      p112 = GF::Person.new(:name => compose_name(lv(1), 1, 2)); add_person(p112)
      p113 = GF::Person.new(:name => compose_name(lv(1), 1, 3)); add_person(p113)
      p114 = GF::Person.new(:name => compose_name(lv(1), 1, 4)); add_person(p114)
      p121 = GF::Person.new(:name => compose_name(lv(1), 2, 1)); add_person(p121)
      p122 = GF::Person.new(:name => compose_name(lv(1), 2, 2)); add_person(p122)
      p123 = GF::Person.new(:name => compose_name(lv(1), 2, 3)); add_person(p123)
      p124 = GF::Person.new(:name => compose_name(lv(1), 2, 4)); add_person(p124)
      p211 = GF::Person.new(:name => compose_name(lv(2), 1, 1)); add_person(p211)
      p211.put_load(p111, @default_hand_rate)
      p211.put_load(p112, @default_hand_rate)
      p212 = GF::Person.new(:name => compose_name(lv(2), 1, 2)); add_person(p212)
      p212.put_load(p112, @default_hand_rate)
      p212.put_load(p113, @default_hand_rate)
      p213 = GF::Person.new(:name => compose_name(lv(2), 1, 3)); add_person(p213)
      p213.put_load(p113, @default_hand_rate)
      p213.put_load(p114, @default_hand_rate)
      p221 = GF::Person.new(:name => compose_name(lv(2), 2, 1)); add_person(p221)
      p221.put_load(p121, @default_hand_rate)
      p221.put_load(p122, @default_hand_rate)
      p222 = GF::Person.new(:name => compose_name(lv(2), 2, 2)); add_person(p222)
      p222.put_load(p122, @default_hand_rate)
      p222.put_load(p123, @default_hand_rate)
      p223 = GF::Person.new(:name => compose_name(lv(2), 2, 3)); add_person(p223)
      p223.put_load(p123, @default_hand_rate)
      p223.put_load(p124, @default_hand_rate)
      p311 = GF::Person.new(:name => compose_name(lv(3), 1, 1)); add_person(p311)
      ...
      p312 = GF::Person.new(:name => compose_name(lv(3), 1, 2)); add_person(p312)
      ...
      p321 = GF::Person.new(:name => compose_name(lv(3), 2, 1)); add_person(p321)
      ...
      p322 = GF::Person.new(:name => compose_name(lv(3), 2, 2)); add_person(p322)
      ...
      p42 = GF::Person.new(:name => compose_name(lv(4), 2, 1)); add_person(p42)
      ...
      p51 = GF::Person.new(:name => compose_name(lv(5), 1, 1)); add_person(p51)
